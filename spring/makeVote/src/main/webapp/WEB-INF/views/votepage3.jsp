  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	...
	<section id="content">
		<form action="./votemainpage.jsp" method="post">
			<h1>VotePage[소프트웨어공학과]</h1><br><br>
			<hr>
			<center>
			<table border=2 cellspacing="10" cellpadding="5" style="width:600px">
			<tr>
			<td rowspan=3 align=center><input type=radio name=candidate value="cand3-1"></td><td rowspan=3 size=20 class="can3-1"></td>
			<td rowspan=3 align=center>기호1</td><td colspan=2> </td></tr>
			<tr>
			<td>정</td><td>강한</td></tr>
			<tr>
			<td>부</td><td>유현진</td></tr>
			</table><br>
			<table border=2 cellspacing="10" cellpadding="5" style="width:600px">
			<tr>
			<td rowspan=3 align=center><input type=radio name=candidate value="cand3-2"></td><td rowspan=3 size=20 class="can3-2"></td>
			<td rowspan=3 align=center>기호2</td><td colspan=2> </td></tr>
			<tr>
			<td>정</td><td>소대성</td></tr>
			<tr>
			<td>부</td><td>이정언</td></tr>
			</table><br>
			<table border=2 cellspacing="10" cellpadding="5" style="width:600px">
			<tr>
			<td rowspan=3 align=center><input type=radio name=candidate value="cand3-3"></td><td rowspan=3 size=20 class="can3-3"></td>
			<td rowspan=3 align=center>기호3</td><td colspan=2> </td></tr>
			<tr>
			<td>정</td><td>유인상</td></tr>
			<tr>
			<td>부</td><td>유인하</td></tr>
			</table><br>
