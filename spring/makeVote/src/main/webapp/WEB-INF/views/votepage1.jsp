...
<%
	...
	<section id="content">
		<form action="./votemainpage.jsp" method="post">
			<h1>VotePage[총학생회]</h1><br><br>
			<hr>
			<center>
			<table border=2 cellspacing="10" cellpadding="5" style="width:600px">
			<tr>
			<td rowspan=3 align=center><input type=radio name=candidate value="cand1-1"></td><td rowspan=3 size=20 class="can1-1"></td>
			<td rowspan=3 align=center>기호1</td><td colspan=2> </td></tr>
			<tr>
			<td>정</td><td>김선홍</td></tr>
			<tr>
			<td>부</td><td>김효진</td></tr>
			</table><br>
			<table border=2 cellspacing="10" cellpadding="5" style="width:600px">
			<tr>
			<td rowspan=3 align=center><input type=radio name=candidate value="cand1-2"></td><td rowspan=3 size=20 class="can1-2"></td>
			<td rowspan=3 align=center>기호2</td><td colspan=2> </td></tr>
			<tr>
			<td>정</td><td>이준희</td></tr>
			<tr>
			<td>부</td><td>조수현</td></tr>
			</table><br>
			<table border=2 cellspacing="10" cellpadding="5" style="width:600px">
			<tr>
			<td rowspan=3 align=center><input type=radio name=candidate value="cand1-3"></td><td rowspan=3 size=20 class="can1-3"></td>
			<td rowspan=3 align=center>기호3</td><td colspan=2> </td></tr>
			<tr>
			<td>정</td><td>성웅</td></tr>
			<tr>
			<td>부</td><td>이수아</td></tr>
			</table><br>
			<table border=0 cellspacing="10" cellpadding="5" style="width:400px">
			<tr>
			<td colspan=5 align=center><input type=submit value="투표완료" href="./votemainpage.jsp"></td></tr>
			</table><br>
			</center>
		</form><!-- form -->
